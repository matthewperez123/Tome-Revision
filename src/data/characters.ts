...
export const CHARACTERS: Character[] = [
  ...
  { name: "Dante", role: "protagonist", bookId: "the-divine-comedy", bookTitle: "The Divine Comedy", author: "Dante Alighieri", description: "The pilgrim, lost in a dark wood" },
  { name: "Virgil", role: "supporting", bookId: "the-divine-comedy", bookTitle: "The Divine Comedy", author: "Dante Alighieri", description: "Roman poet, Dante's guide through Hell" },
  { name: "Beatrice", role: "supporting", bookId: "the-divine-comedy", bookTitle: "The Divine Comedy", author: "Dante Alighieri", description: "Dante's beloved, guide through Paradise" },
