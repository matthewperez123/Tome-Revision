        ...
        <div>
          <BlurFade delay={0.15} inView>
            ...
            <p className="text-sm text-muted-foreground mb-8 leading-relaxed max-w-sm">
              No summaries. No abridgements. Complete texts beautifully typeset in Literata, with the reader adapting to the shape of the work: epic, poem, play, or letter.
            </p>
          </BlurFade>
