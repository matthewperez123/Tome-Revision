...
const CALLOUTS = [
  { icon: BookOpen, label: "Typeset for every form", desc: "Chapters, cantos, scenes, acts, books, poems, stories, essays, letters \u2014 each structural unit rendered the way it was meant to be read." },
  { icon: Palette, label: "Three themes, tunable type", desc: "Light, parchment, and Night Scholar modes. Adjustable font size and line height for any screen." },
        ...
        <div>
          <BlurFade delay={0.15} inView>
            ...
            <p className="text-sm text-muted-foreground mb-8 leading-relaxed max-w-sm">
              No summaries. No abridgements. Complete texts beautifully typeset in Literata, with the reader adapting to the shape of the work &mdash; epic, poem, play, or letter.
            </p>
          </BlurFade>
