        ...
        <div>
          <BlurFade delay={0.15} inView>
            ...
            <p className="text-sm text-[#7A756D] mb-8 leading-relaxed max-w-sm">
              No summaries. No abridgements. Complete texts from Standard Ebooks, beautifully typeset in Literata with Virgil&apos;s scholarly annotations appearing exactly when you need them.
            </p>
          </BlurFade>
