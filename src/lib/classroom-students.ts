...
export const DEMO_STUDENT_TRIALS: StudentTrial[] = [
  ...
  { id: "t3", studentId: "s3", date: "2026-04-10", bookTitle: "The Odyssey", unit: "Full Book", difficulty: "Sage", score: 100, wisdomEarned: 100, attempts: 1, questions: [{ text: "Analyze the theme of nostos across the epic.", studentAnswer: "Homecoming as spiritual transformation", correctAnswer: "Homecoming as spiritual transformation", correct: true, explanation: "Nostos (homecoming) is the central theme." }] },
  { id: "t4", studentId: "s4", date: "2026-04-02", bookTitle: "The Odyssey", unit: "Books 1–3", difficulty: "Foundational", score: 55, wisdomEarned: 10, attempts: 2, questions: [{ text: "Where does the story begin?", studentAnswer: "Troy", correctAnswer: "Ithaca/Mount Olympus", correct: false, explanation: "The story opens on Olympus with the gods discussing Odysseus." }, { text: "Who is Odysseus's son?", studentAnswer: "Telemachus", correctAnswer: "Telemachus", correct: true, explanation: "Telemachus is introduced in Book 1." }] },
  { id: "t5", studentId: "s4", date: "2026-03-28", bookTitle: "The Odyssey", unit: "Books 1–3", difficulty: "Foundational", score: 45, wisdomEarned: 5, attempts: 3, questions: [{ text: "Who is the king of Ithaca?", studentAnswer: "Agamemnon", correctAnswer: "Odysseus", correct: false, explanation: "Odysseus is the rightful king of Ithaca." }] },
  { id: "t6", studentId: "s7", date: "2026-04-01", bookTitle: "The Odyssey", unit: "Book 1", difficulty: "Foundational", score: 50, wisdomEarned: 5, attempts: 2, questions: [{ text: "Who narrates the story?", studentAnswer: "Homer", correctAnswer: "The poet (Homer) via the Muse", correct: false, explanation: "The poem begins with an invocation to the Muse." }] },
]
