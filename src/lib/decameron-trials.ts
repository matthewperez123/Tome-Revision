...
export const DECAMERON_TRIALS: Record<number, ChapterQuestion[]> = {
  ...
  2: [
    { id: "dec-plague-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
    ...
    { id: "dec-plague-2", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  3: [
    { id: "dec-i-1-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  5: [
    { id: "dec-i-3-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  38: [
    { id: "dec-iv-intro-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  39: [
    { id: "dec-iv-1-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  43: [
    { id: "dec-iv-5-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  59: [
    { id: "dec-v-9-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
  ...
  71: [
    ...
    { id: "dec-vi-9-2", type: "multiple_choice", difficulty: "Sage", xpReward: 50,
  ...
  120: [
    { id: "dec-x-10-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
    ...
    { id: "dec-x-10-3", type: "true_false", difficulty: "Sage", xpReward: 50,
  ...
  123: [
    { id: "dec-master-1", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
    ...
    { id: "dec-master-2", type: "multiple_choice", difficulty: "Foundational", xpReward: 5,
    ...
    { id: "dec-master-9", type: "multiple_choice", difficulty: "Sage", xpReward: 50,
    ...
    { id: "dec-master-10", type: "multiple_choice", difficulty: "Sage", xpReward: 50,
    ...
    { id: "dec-master-11", type: "multiple_choice", difficulty: "Sage", xpReward: 50,
    ...
    { id: "dec-master-12", type: "multiple_choice", difficulty: "Sage", xpReward: 50,
