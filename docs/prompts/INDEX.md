...
2. **`marketing-nav-determinism`** — ✅ **merged**. Nav mechanics shipped earlier
   (`a681f033…191f696a`); the parked onboarding write-confirmation fix (`819f9c28`)
   landed via the integration merge commit.
...
| `tome-student-badge-login.md` | Student badge / scan-to-enter login | `marketing-nav-determinism`, `stripe-full-integration` | — | `merged` |
